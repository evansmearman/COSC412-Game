...
`)+`
`+p);const y=S+g+o,v=S+p+a,b=Il(i,i.VERTEX_SHADER,y),w=Il(i,i.FRAGMENT_SHADER,v);if(i.attachShader(_,b),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_),r.debug.checkShaderErrors){const M=i.getProgramInfoLog(_).trim(),E=i.getShaderInfoLog(b).trim(),H=i.getShaderInfoLog(w).trim();let J=!0,U=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(J=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,b,w);else{const F=Dl(i,b,"vertex"),G=Dl(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`

Program Info Log: `+M+`
`+F+`
`+G)}else M!==""?console.warn("THREE.WebGLProgram: Program Info Log:",M):(E===""||H==="")&&(U=!1);U&&(this.diagnostics={runnable:J,programLog:M,vertexShader:{log:E,prefix:g},fragmentShader:{log:H,prefix:p}})}i.deleteShader(b),i.deleteShader(w);let C;this.getUniforms=function(){return C===void 0&&(C=new Sr(i,_)),C};let D;return this.getAttributes=function(){return D===void 0&&(D=_g(i,_)),D},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=hg++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=b,this.fragmentShader=w,this}let Cg=0;class Lg{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Pg(e),t.set(e,n)),n}}class Pg{constructor(e){this.id=Cg++,this.code=e,this.usedTimes=0}}function Ig(r,e,t,n,i,s,o){const a=new Zc,l=new Lg,c=[],h=i.isWebGL2,u=i.logarithmicDepthBuffer,d=i.vertexTextures;let f=i.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(M){return M===0?"uv":`uv${M}`}function g(M,E,H,J,U){const F=J.fog,G=U.geometry,V=M.isMeshStandardMaterial?J.environment:null,N=(M.isMeshStandardMaterial?t:e).get(M.envMap||V),Q=N&&N.mapping===Cr?N.image.height:null,te=m[M.type];M.precision!==null&&(f=i.getMaxPrecision(M.precision),f!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",f,"instead."));const K=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,O=K!==void 0?K.length:0;let $=0;G.morphAttributes.position!==void 0&&($=1),G.morphAttributes.normal!==void 0&&($=2),G.morphAttributes.color!==void 0&&($=3);let de,pe,_e,ye;if(te){const at=pn[te];de=at.vertexShader,pe=at.fragmentShader}else de=M.vertexShader,pe=M.fragmentShader,l.update(M),_e=l.getVertexShaderID(M),ye=l.getFragmentShaderID(M);const Se=r.getRenderTarget(),Te=U.isInstancedMesh===!0,Xe=!!M.map,et=!!M.matcap,Pe=!!N,L=!!M.aoMap,ce=!!M.lightMap,Z=!!M.bumpMap,se=!!M.normalMap,ne=!!M.displacementMap,Ae=!!M.emissiveMap,xe=!!M.metalnessMap,be=!!M.roughnessMap,Be=M.anisotropy>0,De=M.clearcoat>0,ct=M.iridescence>0,R=M.sheen>0,x=M.transmission>0,W=Be&&!!M.anisotropyMap,re=De&&!!M.clearcoatMap,ie=De&&!!M.clearcoatNormalMap,oe=De&&!!M.clearcoatRoughnessMap,we=ct&&!!M.iridescenceMap,le=ct&&!!M.iridescenceThicknessMap,Y=R&&!!M.sheenColorMap,Ce=R&&!!M.sheenRoughnessMap,Le=!!M.specularMap,Ie=!!M.specularColorMap,Ee=!!M.specularIntensityMap,Me=x&&!!M.transmissionMap,Ge=x&&!!M.thicknessMap,st=!!M.gradientMap,I=!!M.alphaMap,me=M.alphaTest>0,k=!!M.alphaHash,ue=!!M.extensions,ge=!!G.attributes.uv1,Ze=!!G.attributes.uv2,ht=!!G.attributes.uv3;let gt=Yn;return M.toneMapped&&(Se===null||Se.isXRRenderTarget===!0)&&(gt=r.toneMapping),{isWebGL2:h,shaderID:te,shaderType:M.type,shaderName:M.name,vertexShader:de,fragmentShader:pe,defines:M.defines,customVertexShaderID:_e,customFragmentShaderID:ye,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:f,instancing:Te,instancingColor:Te&&U.instanceColor!==null,supportsVertexTextures:d,outputColorSpace:Se===null?r.outputColorSpace:Se.isXRRenderTarget===!0?Se.texture.colorSpace:Ct,map:Xe,matcap:et,envMap:Pe,envMapMode:Pe&&N.mapping,envMapCubeUVHeight:Q,aoMap:L,lightMap:ce,bumpMap:Z,normalMap:se,displacementMap:d&&ne,emissiveMap:Ae,normalMapObjectSpace:se&&M.normalMapType===Tu,normalMapTangentSpace:se&&M.normalMapType===ns,metalnessMap:xe,roughnessMap:be,anisotropy:Be,anisotropyMap:W,clearcoat:De,clearcoatMap:re,clearcoatNormalMap:ie,clearcoatRoughnessMap:oe,iridescence:ct,iridescenceMap:we,iridescenceThicknessMap:le,sheen:R,sheenColorMap:Y,sheenRoughnessMap:Ce,specularMap:Le,specularColorMap:Ie,specularIntensityMap:Ee,transmission:x,transmissionMap:Me,thicknessMap:Ge,gradientMap:st,opaque:M.transparent===!1&&M.blending===Vi,alphaMap:I,alphaTest:me,alphaHash:k,combine:M.combine,mapUv:Xe&&_(M.map.channel),aoMapUv:L&&_(M.aoMap.channel),lightMapUv:ce&&_(M.lightMap.channel),bumpMapUv:Z&&_(M.bumpMap.channel),normalMapUv:se&&_(M.normalMap.channel),displacementMapUv:ne&&_(M.displacementMap.channel),emissiveMapUv:Ae&&_(M.emissiveMap.channel),metalnessMapUv:xe&&_(M.metalnessMap.channel),roughnessMapUv:be&&_(M.roughnessMap.channel),anisotropyMapUv:W&&_(M.anisotropyMap.channel),clearcoatMapUv:re&&_(M.clearcoatMap.channel),clearcoatNormalMapUv:ie&&_(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:oe&&_(M.clearcoatRoughnessMap.channel),iridescenceMapUv:we&&_(M.iridescenceMap.channel),iridescenceThicknessMapUv:le&&_(M.iridescenceThicknessMap.channel),sheenColorMapUv:Y&&_(M.sheenColorMap.channel),sheenRoughnessMapUv:Ce&&_(M.sheenRoughnessMap.channel),specularMapUv:Le&&_(M.specularMap.channel),specularColorMapUv:Ie&&_(M.specularColorMap.channel),specularIntensityMapUv:Ee&&_(M.specularIntensityMap.channel),transmissionMapUv:Me&&_(M.transmissionMap.channel),thicknessMapUv:Ge&&_(M.thicknessMap.channel),alphaMapUv:I&&_(M.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(se||Be),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,vertexUv1s:ge,vertexUv2s:Ze,vertexUv3s:ht,pointsUvs:U.isPoints===!0&&!!G.attributes.uv&&(Xe||I),fog:!!F,useFog:M.fog===!0,fogExp2:F&&F.isFogExp2,flatShading:M.flatShading===!0,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:u,skinning:U.isSkinnedMesh===!0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:O,morphTextureStride:$,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:M.dithering,shadowMapEnabled:r.shadowMap.enabled&&H.length>0,shadowMapType:r.shadowMap.type,toneMapping:gt,useLegacyLights:r._useLegacyLights,decodeVideoTexture:Xe&&M.map.isVideoTexture===!0&&M.map.colorSpace===rt,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===un,flipSided:M.side===kt,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionDerivatives:ue&&M.extensions.derivatives===!0,extensionFragDepth:ue&&M.extensions.fragDepth===!0,extensionDrawBuffers:ue&&M.extensions.drawBuffers===!0,extensionShaderTextureLOD:ue&&M.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:h||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:h||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:h||n.has("EXT_shader_texture_lod"),customProgramCacheKey:M.customProgramCacheKey()}}function p(M){const E=[];if(M.shaderID?E.push(M.shaderID):(E.push(M.customVertexShaderID),E.push(M.customFragmentShaderID)),M.defines!==void 0)for(const H in M.defines)E.push(H),E.push(M.defines[H]);return M.isRawShaderMaterial===!1&&(S(E,M),y(E,M),E.push(r.outputColorSpace)),E.push(M.customProgramCacheKey),E.join()}function S(M,E){M.push(E.precision),M.push(E.outputColorSpace),M.push(E.envMapMode),M.push(E.envMapCubeUVHeight),M.push(E.mapUv),M.push(E.alphaMapUv),M.push(E.lightMapUv),M.push(E.aoMapUv),M.push(E.bumpMapUv),M.push(E.normalMapUv),M.push(E.displacementMapUv),M.push(E.emissiveMapUv),M.push(E.metalnessMapUv),M.push(E.roughnessMapUv),M.push(E.anisotropyMapUv),M.push(E.clearcoatMapUv),M.push(E.clearcoatNormalMapUv),M.push(E.clearcoatRoughnessMapUv),M.push(E.iridescenceMapUv),M.push(E.iridescenceThicknessMapUv),M.push(E.sheenColorMapUv),M.push(E.sheenRoughnessMapUv),M.push(E.specularMapUv),M.push(E.specularColorMapUv),M.push(E.specularIntensityMapUv),M.push(E.transmissionMapUv),M.push(E.thicknessMapUv),M.push(E.combine),M.push(E.fogExp2),M.push(E.sizeAttenuation),M.push(E.morphTargetsCount),M.push(E.morphAttributeCount),M.push(E.numDirLights),M.push(E.numPointLights),M.push(E.numSpotLights),M.push(E.numSpotLightMaps),M.push(E.numHemiLights),M.push(E.numRectAreaLights),M.push(E.numDirLightShadows),M.push(E.numPointLightShadows),M.push(E.numSpotLightShadows),M.push(E.numSpotLightShadowsWithMaps),M.push(E.shadowMapType),M.push(E.toneMapping),M.push(E.numClippingPlanes),M.push(E.numClipIntersection),M.push(E.depthPacking)}function y(M,E){a.disableAll(),E.isWebGL2&&a.enable(0),E.supportsVertexTextures&&a.enable(1),E.instancing&&a.enable(2),E.instancingColor&&a.enable(3),E.matcap&&a.enable(4),E.envMap&&a.enable(5),E.normalMapObjectSpace&&a.enable(6),E.normalMapTangentSpace&&a.enable(7),E.clearcoat&&a.enable(8),E.iridescence&&a.enable(9),E.alphaTest&&a.enable(10),E.vertexColors&&a.enable(11),E.vertexAlphas&&a.enable(12),E.vertexUv1s&&a.enable(13),E.vertexUv2s&&a.enable(14),E.vertexUv3s&&a.enable(15),E.vertexTangents&&a.enable(16),E.anisotropy&&a.enable(17),M.push(a.mask),a.disableAll(),E.fog&&a.enable(0),E.useFog&&a.enable(1),E.flatShading&&a.enable(2),E.logarithmicDepthBuffer&&a.enable(3),E.skinning&&a.enable(4),E.morphTargets&&a.enable(5),E.morphNormals&&a.enable(6),E.morphColors&&a.enable(7),E.premultipliedAlpha&&a.enable(8),E.shadowMapEnabled&&a.enable(9),E.useLegacyLights&&a.enable(10),E.doubleSided&&a.enable(11),E.flipSided&&a.enable(12),E.useDepthPacking&&a.enable(13),E.dithering&&a.enable(14),E.transmission&&a.enable(15),E.sheen&&a.enable(16),E.opaque&&a.enable(17),E.pointsUvs&&a.enable(18),E.decodeVideoTexture&&a.enable(19),M.push(a.mask)}function v(M){const E=m[M.type];let H;if(E){const J=pn[E];H=_d.clone(J.uniforms)}else H=M.uniforms;return H}function b(M,E){let H;for(let J=0,U=c.length;J<U;J++){const F=c[J];if(F.cacheKey===E){H=F,++H.usedTimes;break}}return H===void 0&&(H=new Rg(r,E,M,s),c.push(H)),H}function w(M){if(--M.usedTimes===0){const E=c.indexOf(M);c[E]=c[c.length-1],c.pop(),M.destroy()}}function C(M){l.remove(M)}function D(){l.dispose()}return{getParameters:g,getProgramCacheKey:p,getUniforms:v,acquireProgram:b,releaseProgram:w,releaseShaderCache:C,programs:c,dispose:D}}function Dg(){let r=new WeakMap;function e(s){let o=r.get(s);return o===void 0&&(o={},r.set(s,o)),o}function t(s){r.delete(s)}function n(s,o,a){r.get(s)[o]=a}function i(){r=new WeakMap}return{get:e,remove:t,update:n,dispose:i}}function Ug(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function Bl(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function zl(){const r=[];let e=0;const t=[],n=[],i=[];function s(){e=0,t.length=0,n.length=0,i.length=0}function o(u,d,f,m,_,g){let p=r[e];return p===void 0?(p={id:u.id,object:u,geometry:d,material:f,groupOrder:m,renderOrder:u.renderOrder,z:_,group:g},r[e]=p):(p.id=u.id,p.object=u,p.geometry=d,p.material=f,p.groupOrder=m,p.renderOrder=u.renderOrder,p.z=_,p.group=g),e++,p}function a(u,d,f,m,_,g){const p=o(u,d,f,m,_,g);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):t.push(p)}function l(u,d,f,m,_,g){const p=o(u,d,f,m,_,g);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):t.unshift(p)}function c(u,d){t.length>1&&t.sort(u||Ug),n.length>1&&n.sort(d||Bl),i.length>1&&i.sort(d||Bl)}function h(){for(let u=e,d=r.length;u<d;u++){const f=r[u];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:i,init:s,push:a,unshift:l,finish:h,sort:c}}function Ng(){let r=new WeakMap;function e(n,i){const s=r.get(n);let o;return s===void 0?(o=new zl,r.set(n,[o])):i>=s.length?(o=new zl,s.push(o)):o=s[i],o}function t(){r=new WeakMap}return{get:e,dispose:t}}function Fg(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new A,color:new Ne};break;case"SpotLight":t={position:new A,direction:new A,color:new Ne,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new A,color:new Ne,distance:0,decay:0};break;case"HemisphereLight":t={direction:new A,skyColor:new Ne,groundColor:new Ne};break;case"RectAreaLight":t={color:new Ne,position:new A,halfWidth:new A,halfHeight:new A};break}return r[e.id]=t,t}}}function Og(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new he,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let Bg=0;function zg(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function Vg(r,e){const t=new Fg,n=Og(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0};for(let h=0;h<9;h++)i.probe.push(new A);const s=new A,o=new Oe,a=new Oe;function l(h,u){let d=0,f=0,m=0;for(let H=0;H<9;H++)i.probe[H].set(0,0,0);let _=0,g=0,p=0,S=0,y=0,v=0,b=0,w=0,C=0,D=0;h.sort(zg);const M=u===!0?Math.PI:1;for(let H=0,J=h.length;H<J;H++){const U=h[H],F=U.color,G=U.intensity,V=U.distance,N=U.shadow&&U.shadow.map?U.shadow.map.texture:null;if(U.isAmbientLight)d+=F.r*G*M,f+=F.g*G*M,m+=F.b*G*M;else if(U.isLightProbe)for(let Q=0;Q<9;Q++)i.probe[Q].addScaledVector(U.sh.coefficients[Q],G);else if(U.isDirectionalLight){const Q=t.get(U);if(Q.color.copy(U.color).multiplyScalar(U.intensity*M),U.castShadow){const te=U.shadow,K=n.get(U);K.shadowBias=te.bias,K.shadowNormalBias=te.normalBias,K.shadowRadius=te.radius,K.shadowMapSize=te.mapSize,i.directionalShadow[_]=K,i.directionalShadowMap[_]=N,i.directionalShadowMatrix[_]=U.shadow.matrix,v++}i.directional[_]=Q,_++}else if(U.isSpotLight){const Q=t.get(U);Q.position.setFromMatrixPosition(U.matrixWorld),Q.color.copy(F).multiplyScalar(G*M),Q.distance=V,Q.coneCos=Math.cos(U.angle),Q.penumbraCos=Math.cos(U.angle*(1-U.penumbra)),Q.decay=U.decay,i.spot[p]=Q;const te=U.shadow;if(U.map&&(i.spotLightMap[C]=U.map,C++,te.updateMatrices(U),U.castShadow&&D++),i.spotLightMatrix[p]=te.matrix,U.castShadow){const K=n.get(U);K.shadowBias=te.bias,K.shadowNormalBias=te.normalBias,K.shadowRadius=te.radius,K.shadowMapSize=te.mapSize,i.spotShadow[p]=K,i.spotShadowMap[p]=N,w++}p++}else if(U.isRectAreaLight){const Q=t.get(U);Q.color.copy(F).multiplyScalar(G),Q.halfWidth.set(U.width*.5,0,0),Q.halfHeight.set(0,U.height*.5,0),i.rectArea[S]=Q,S++}else if(U.isPointLight){const Q=t.get(U);if(Q.color.copy(U.color).multiplyScalar(U.intensity*M),Q.distance=U.distance,Q.decay=U.decay,U.castShadow){const te=U.shadow,K=n.get(U);K.shadowBias=te.bias,K.shadowNormalBias=te.normalBias,K.shadowRadius=te.radius,K.shadowMapSize=te.mapSize,K.shadowCameraNear=te.camera.near,K.shadowCameraFar=te.camera.far,i.pointShadow[g]=K,i.pointShadowMap[g]=N,i.pointShadowMatrix[g]=U.shadow.matrix,b++}i.point[g]=Q,g++}else if(U.isHemisphereLight){const Q=t.get(U);Q.skyColor.copy(U.color).multiplyScalar(G*M),Q.groundColor.copy(U.groundColor).multiplyScalar(G*M),i.hemi[y]=Q,y++}}S>0&&(e.isWebGL2||r.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=fe.LTC_FLOAT_1,i.rectAreaLTC2=fe.LTC_FLOAT_2):r.has("OES_texture_half_float_linear")===!0?(i.rectAreaLTC1=fe.LTC_HALF_1,i.rectAreaLTC2=fe.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),i.ambient[0]=d,i.ambient[1]=f,i.ambient[2]=m;const E=i.hash;(E.directionalLength!==_||E.pointLength!==g||E.spotLength!==p||E.rectAreaLength!==S||E.hemiLength!==y||E.numDirectionalShadows!==v||E.numPointShadows!==b||E.numSpotShadows!==w||E.numSpotMaps!==C)&&(i.directional.length=_,i.spot.length=p,i.rectArea.length=S,i.point.length=g,i.hemi.length=y,i.directionalShadow.length=v,i.directionalShadowMap.length=v,i.pointShadow.length=b,i.pointShadowMap.length=b,i.spotShadow.length=w,i.spotShadowMap.length=w,i.directionalShadowMatrix.length=v,i.pointShadowMatrix.length=b,i.spotLightMatrix.length=w+C-D,i.spotLightMap.length=C,i.numSpotLightShadowsWithMaps=D,E.directionalLength=_,E.pointLength=g,E.spotLength=p,E.rectAreaLength=S,E.hemiLength=y,E.numDirectionalShadows=v,E.numPointShadows=b,E.numSpotShadows=w,E.numSpotMaps=C,i.version=Bg++)}function c(h,u){let d=0,f=0,m=0,_=0,g=0;const p=u.matrixWorldInverse;for(let S=0,y=h.length;S<y;S++){const v=h[S];if(v.isDirectionalLight){const b=i.directional[d];b.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),b.direction.sub(s),b.direction.transformDirection(p),d++}else if(v.isSpotLight){const b=i.spot[m];b.position.setFromMatrixPosition(v.matrixWorld),b.position.applyMatrix4(p),b.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),b.direction.sub(s),b.direction.transformDirection(p),m++}else if(v.isRectAreaLight){const b=i.rectArea[_];b.position.setFromMatrixPosition(v.matrixWorld),b.position.applyMatrix4(p),a.identity(),o.copy(v.matrixWorld),o.premultiply(p),a.extractRotation(o),b.halfWidth.set(v.width*.5,0,0),b.halfHeight.set(0,v.height*.5,0),b.halfWidth.applyMatrix4(a),b.halfHeight.applyMatrix4(a),_++}else if(v.isPointLight){const b=i.point[f];b.position.setFromMatrixPosition(v.matrixWorld),b.position.applyMatrix4(p),f++}else if(v.isHemisphereLight){const b=i.hemi[g];b.direction.setFromMatrixPosition(v.matrixWorld),b.direction.transformDirection(p),g++}}}return{setup:l,setupView:c,state:i}}function Vl(r,e){const t=new Vg(r,e),n=[],i=[];function s(){n.length=0,i.length=0}function o(u){n.push(u)}function a(u){i.push(u)}function l(u){t.setup(n,u)}function c(u){t.setupView(n,u)}return{init:s,state:{lightsArray:n,shadowsArray:i,lights:t},setupLights:l,setupLightsView:c,pushLight:o,pushShadow:a}}function kg(r,e){let t=new WeakMap;function n(s,o=0){const a=t.get(s);let l;return a===void 0?(l=new Vl(r,e),t.set(s,[l])):o>=a.length?(l=new Vl(r,e),a.push(l)):l=a[o],l}function i(){t=new WeakMap}return{get:n,dispose:i}}class Hg extends Wt{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=bu,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Gg extends Wt{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Wg=`void main() {
	gl_Position = vec4( position, 1.0 );
 ...
 */const Us={BOX:"box",CYLINDER:"cylinder",SPHERE:"sphere",CAPSULE:"capsule",CONE:"cone",HULL:"hull",HACD:"hacd",VHACD:"vhacd",MESH:"mesh",HEIGHTFIELD:"heightfield"},Ns={ALL:"all",MANUAL:"manual"},gy=function(){const r=new A,e=new A,t=new Oe;return function(n,i,s,o={}){if(o.type=Us.HULL,Br(o),o.fit===Ns.MANUAL)return console.warn("cannot use fit: manual with type: hull"),null;const a=Ea(n,i),l=new Ammo.btVector3,c=new Ammo.btConvexHullShape;c.setMargin(o.margin),e.addVectors(a.max,a.min).multiplyScalar(.5);let h=0;for(let m=0;m<n.length;m++)h+=n[m].length/3;const u=o.hullMaxVertices||1e5;h>u&&console.warn(`too many vertices for hull shape; sampling ~${u} from ~${h} vertices`);const d=Math.min(1,u/h);for(let m=0;m<n.length;m++){const _=n[m];t.fromArray(i[m]);for(let g=0;g<_.length;g+=3){const p=m===n.length-1&&g===_.length-3;(Math.random()<=d||p)&&(r.set(_[g],_[g+1],_[g+2]).applyMatrix4(t).sub(e),l.setValue(r.x,r.y,r.z),c.addPoint(l,p))}}let f=c;if(c.getNumVertices()>=100){const m=new Ammo.btShapeHull(c);m.buildHull(o.margin),Ammo.destroy(c),f=new Ammo.btConvexHullShape(Ammo.getPointer(m.getVertexPointer()),m.numVertices()),Ammo.destroy(m)}return Ammo.destroy(l),zr(f,o,Vr(s,o)),f}}(),_y=function(){const r=new A,e=new A,t=new Oe;return function(n,i,s,o,a={}){if(a.type=Us.HACD,Br(a),a.fit===Ns.MANUAL)return console.warn("cannot use fit: manual with type: hacd"),[];if(!Ammo.hasOwnProperty("HACD"))return console.warn("HACD unavailable in included build of Ammo.js. Visit https://github.com/mozillareality/ammo.js for the latest version."),[];const l=Ea(n,i);Vr(o,a);let c=0,h=0;e.addVectors(l.max,l.min).multiplyScalar(.5);for(let S=0;S<n.length;S++)c+=n[S].length/3,s&&s[S]?h+=s[S].length/3:h+=n[S].length/9;const u=new Ammo.HACD;a.hasOwnProperty("compacityWeight")&&u.SetCompacityWeight(a.compacityWeight),a.hasOwnProperty("volumeWeight")&&u.SetVolumeWeight(a.volumeWeight),a.hasOwnProperty("nClusters")&&u.SetNClusters(a.nClusters),a.hasOwnProperty("nVerticesPerCH")&&u.SetNVerticesPerCH(a.nVerticesPerCH),a.hasOwnProperty("concavity")&&u.SetConcavity(a.concavity);const d=Ammo._malloc(c*3*8),f=Ammo._malloc(h*3*4);u.SetPoints(d),u.SetTriangles(f),u.SetNPoints(c),u.SetNTriangles(h);let m=d/8,_=f/4;for(let S=0;S<n.length;S++){const y=n[S];t.fromArray(i[S]);for(let v=0;v<y.length;v+=3)r.set(y[v+0],y[v+1],y[v+2]).applyMatrix4(t).sub(e),Ammo.HEAPF64[m+0]=r.x,Ammo.HEAPF64[m+1]=r.y,Ammo.HEAPF64[m+2]=r.z,m+=3;if(s[S]){const v=s[S];for(let b=0;b<v.length;b++)Ammo.HEAP32[_]=v[b],_++}else for(let v=0;v<y.length/3;v++)Ammo.HEAP32[_]=v,_++}u.Compute(),Ammo._free(d),Ammo._free(f);const g=u.GetNClusters(),p=[];for(let S=0;S<g;S++){const y=new Ammo.btConvexHullShape;y.setMargin(a.margin);const v=u.GetNPointsCH(S),b=u.GetNTrianglesCH(S),w=Ammo._malloc(v*3*8),C=Ammo._malloc(b*3*4);u.GetCH(S,w,C);const D=w/8;for(let M=0;M<v;M++){const E=new Ammo.btVector3,H=Ammo.HEAPF64[D+M*3+0],J=Ammo.HEAPF64[D+M*3+1],U=Ammo.HEAPF64[D+M*3+2];E.setValue(H,J,U),y.addPoint(E,M===v-1),Ammo.destroy(E)}zr(),p.push(y)}return p}}(),yy=function(){const r=new A,e=new A,t=new Oe;return function(n,i,s,o,a={}){if(a.type=Us.VHACD,Br(a),a.fit===Ns.MANUAL)return console.warn("cannot use fit: manual with type: vhacd"),[];if(!Ammo.hasOwnProperty("VHACD"))return console.warn("VHACD unavailable in included build of Ammo.js. Visit https://github.com/mozillareality/ammo.js for the latest version."),[];const l=Ea(n,i);Vr(o,a);let c=0,h=0;e.addVectors(l.max,l.min).multiplyScalar(.5);for(let v=0;v<n.length;v++)c+=n[v].length/3,s&&s[v]?h+=s[v].length/3:h+=n[v].length/9;const u=new Ammo.VHACD,d=new Ammo.Parameters;a.hasOwnProperty("resolution")&&d.set_m_resolution(a.resolution),a.hasOwnProperty("depth")&&d.set_m_depth(a.depth),a.hasOwnProperty("concavity")&&d.set_m_concavity(a.concavity),a.hasOwnProperty("planeDownsampling")&&d.set_m_planeDownsampling(a.planeDownsampling),a.hasOwnProperty("convexhullDownsampling")&&d.set_m_convexhullDownsampling(a.convexhullDownsampling),a.hasOwnProperty("alpha")&&d.set_m_alpha(a.alpha),a.hasOwnProperty("beta")&&d.set_m_beta(a.beta),a.hasOwnProperty("gamma")&&d.set_m_gamma(a.gamma),a.hasOwnProperty("pca")&&d.set_m_pca(a.pca),a.hasOwnProperty("mode")&&d.set_m_mode(a.mode),a.hasOwnProperty("maxNumVerticesPerCH")&&d.set_m_maxNumVerticesPerCH(a.maxNumVerticesPerCH),a.hasOwnProperty("minVolumePerCH")&&d.set_m_minVolumePerCH(a.minVolumePerCH),a.hasOwnProperty("convexhullApproximation")&&d.set_m_convexhullApproximation(a.convexhullApproximation),a.hasOwnProperty("oclAcceleration")&&d.set_m_oclAcceleration(a.oclAcceleration);const f=Ammo._malloc(c*3*8+3),m=Ammo._malloc(h*3*4);let _=f/8,g=m/4;for(let v=0;v<n.length;v++){const b=n[v];t.fromArray(i[v]);for(let w=0;w<b.length;w+=3)r.set(b[w+0],b[w+1],b[w+2]).applyMatrix4(t).sub(e),Ammo.HEAPF64[_+0]=r.x,Ammo.HEAPF64[_+1]=r.y,Ammo.HEAPF64[_+2]=r.z,_+=3;if(s[v]){const w=s[v];for(let C=0;C<w.length;C++)Ammo.HEAP32[g]=w[C],g++}else for(let w=0;w<b.length/3;w++)Ammo.HEAP32[g]=w,g++}u.Compute(f,3,c,m,3,h,d),Ammo._free(f),Ammo._free(m);const p=u.GetNConvexHulls(),S=[],y=new Ammo.ConvexHull;for(let v=0;v<p;v++){u.GetConvexHull(v,y);const b=y.get_m_nPoints();y.get_m_points();const w=new Ammo.btConvexHullShape;w.setMargin(a.margin);for(let C=0;C<b;C++){const D=new Ammo.btVector3,M=y.get_m_points(C*3+0),E=y.get_m_points(C*3+1),H=y.get_m_points(C*3+2);D.setValue(M,E,H),w.addPoint(D,C===b-1),Ammo.destroy(D)}zr(),S.push(w)}return Ammo.destroy(y),Ammo.destroy(u),S}}(),Do=function(){const r=new A,e=new A,t=new A,n=new Oe;return function(i,s,o,a,l={}){if(l.type=Us.MESH,Br(l),l.fit===Ns.MANUAL)return console.warn("cannot use fit: manual with type: mesh"),null;const c=Vr(a,l),h=new Ammo.btVector3,u=new Ammo.btVector3,d=new Ammo.btVector3,f=new Ammo.btTriangleMesh(!0,!1);for(let g=0;g<i.length;g++){const p=i[g],S=o[g]?o[g]:null;if(n.fromArray(s[g]),S)for(let y=0;y<S.length;y+=3){const v=S[y]*3,b=S[y+1]*3,w=S[y+2]*3;r.set(p[v],p[v+1],p[v+2]).applyMatrix4(n),e.set(p[b],p[b+1],p[b+2]).applyMatrix4(n),t.set(p[w],p[w+1],p[w+2]).applyMatrix4(n),h.setValue(r.x,r.y,r.z),u.setValue(e.x,e.y,e.z),d.setValue(t.x,t.y,t.z),f.addTriangle(h,u,d,!1)}else for(let y=0;y<p.length;y+=9)r.set(p[y+0],p[y+1],p[y+2]).applyMatrix4(n),e.set(p[y+3],p[y+4],p[y+5]).applyMatrix4(n),t.set(p[y+6],p[y+7],p[y+8]).applyMatrix4(n),h.setValue(r.x,r.y,r.z),u.setValue(e.x,e.y,e.z),d.setValue(t.x,t.y,t.z),f.addTriangle(h,u,d,!1)}const m=new Ammo.btVector3(c.x,c.y,c.z);f.setScaling(m),Ammo.destroy(m);let _;return l.concave?_=new Ammo.btBvhTriangleMeshShape(f,!0,!0):_=new Ammo.btConvexTriangleMeshShape(f,!0),_.resources=[f],Ammo.destroy(h),Ammo.destroy(u),Ammo.destroy(d),zr(),_}}();function Br(r){r.type=r.type||Us.HULL,r.margin=r.hasOwnProperty("margin")?r.margin:.01}const zr=function(r,e,t){},xy=function(){const r=new Oe;return function(e,t,n){parseInt(Ps)>=123?r.copy(e.matrixWorld).invert():r.getInverse(e.matrixWorld),new A().setFromMatrixScale(e.matrixWorld),e.traverse(s=>{const o=new Oe;s.isMesh&&(t.includeInvisible||s.el&&s.el.object3D.visible||s.visible)&&(s===e?o.identity():(s.updateWorldMatrix(!0),o.multiplyMatrices(r,s.matrixWorld)),n(s.geometry.isBufferGeometry?s.geometry.attributes.position.array:s.geometry.vertices,o.elements,s.geometry.index?s.geometry.index.array:null))})}}(),Vr=function(){const r=new Oe;return function(e,t={}){const n=new A(1,1,1);return t.fit===Ns.ALL&&(r.fromArray(e),n.setFromMatrixScale(r)),n}}();(function(){const r=new A;return function(e,t,n){let i=0,{x:s,y:o,z:a}=n.getCenter(r);return Rh(e,t,l=>{const c=s-l.x,h=o-l.y,u=a-l.z;i=Math.max(i,c*c+h*h+u*u)}),Math.sqrt(i)}})();const Ea=function(r,e){const t=new rn;let n=1/0,i=1/0,s=1/0,o=-1/0,a=-1/0,l=-1/0;return t.min.set(0,0,0),t.max.set(0,0,0),Rh(r,e,c=>{c.x<n&&(n=c.x),c.y<i&&(i=c.y),c.z<s&&(s=c.z),c.x>o&&(o=c.x),c.y>a&&(a=c.y),c.z>l&&(l=c.z)}),t.min.set(n,i,s),t.max.set(o,a,l),t},Rh=function(){const r=new A,e=new Oe;return function(t,n,i){for(let s=0;s<t.length;s++){e.fromArray(n[s]);for(let o=0;o<t[s].length;o+=3)r.set(t[s][o],t[s][o+1],t[s][o+2]).applyMatrix4(e),i(r)}}}();/**
 * @author       Yannick Deubel (https://github.com/yandeu)
 * @copyright    Copyright (c) 2020 Yannick Deubel; Project Url: https://github.com/enable3d/enable3d
 * @license      {@link https://github.com/enable3d/enable3d/blob/master/LICENSE|LGPL-3.0}
 ...
 */class Uy extends Ls{constructor(e,t={}){super(),this.scene=e,this.config=t,this.rigidBodies=[],this.earlierDetectedCollisions=[],this.complexShapes=["plane","hull","hacd","vhacd","convexMesh","concaveMesh"],this.gravity=t.gravity||{x:0,y:-9.81,z:0},this.isHeadless=e==="headless",this.tmpEuler=new is,this.tmpQuaternion=new It,this.tmpVector3=new A,this.tmpVector3a=new A,this.tmpMatrix4=new Oe,this.tmpMatrix4a=new Oe,this.tmpBtVector3=new Ammo.btVector3,this.tmpBtQuaternion=new Ammo.btQuaternion(0,0,0,1),this.emptyV3=new A,this.impactPoint=new A,this.impactNormal=new A,e!=="headless"&&(this.defaultMaterial=new Ch),this.start()}get tmpTrans(){return console.warn("Use worldTransform instead of tmpTrans."),this.worldTransform}set tmpTrans(e){console.warn("Use worldTransform instead of tmpTrans."),this.worldTransform=e}destroy(e){var s;const t=Object.keys(e).includes("body")?e.body:e;if(typeof(t==null?void 0:t.ammo)>"u")return;let n=t.ammo.threeObject;const i=n.name;if(i&&n&&(s=n==null?void 0:n.body)!=null&&s.ammo){n.body.isSoftBody?this.physicsWorld.removeSoftBody(n.body.ammo):this.physicsWorld.removeRigidBody(n.body.ammo),n.body.destructor(),n.body=void 0,n.hasBody=!1,delete t.ammo.threeObject;for(let o=0;o<this.rigidBodies.length;o++)this.rigidBodies[o].name===i&&(this.rigidBodies.splice(o,1),o--)}this.scene==="headless"&&n&&(n=null)}setup(){if(this.worldTransform=new Ammo.btTransform,typeof this.config.setupPhysicsWorld=="function"?this.physicsWorld=this.config.setupPhysicsWorld():this.physicsWorld=this.setupPhysicsWorld(),this.scene!=="headless"){this.convexBreaker=new gn,this.objectsToRemove=[],this.numObjectsToRemove=0;for(let e=0;e<500;e++)this.objectsToRemove[e]=null}this.collisionEvents=new Sy,this.factory=new My(this.scene),this.shapes=new py(this.factory,(e,t)=>this.addExisting(e,t)),this.constraints=new my(this.worldTransform,this.physicsWorld),this.scene!=="headless"&&(this.debugDrawer=new by(this.scene,this.physicsWorld,{}))}updateDebugger(){this.scene!=="headless"&&this.debugDrawer&&this.debugDrawer.enabled&&this.debugDrawer.update()}setupPhysicsWorld(){const e=this.gravity,{softBodies:t=!1}=this.config;let n;if(!t){const i=new Ammo.btDefaultCollisionConfiguration,s=new Ammo.btCollisionDispatcher(i),o=new Ammo.btDbvtBroadphase,a=new Ammo.btSequentialImpulseConstraintSolver;n=new Ammo.btDiscreteDynamicsWorld(s,o,a,i)}if(t){const i=new Ammo.btSoftBodyRigidBodyCollisionConfiguration,s=new Ammo.btCollisionDispatcher(i),o=new Ammo.btDbvtBroadphase,a=new Ammo.btSequentialImpulseConstraintSolver,l=new Ammo.btDefaultSoftBodySolver;n=new Ammo.btSoftRigidDynamicsWorld(s,o,a,i,l)}return n.setGravity(new Ammo.btVector3(e.x,e.y,e.z)),n}createDebrisFromBreakableObject(e,t){this.scene!=="headless"&&(e.material=t.material,e.shape="hull",e.fragmentDepth=t.fragmentDepth+1,e.name=`${t.name}__DEBRIS_${e.id}`,this.scene.add(e),this.addExisting(e,{autoCenter:!0}),e.body.fractureImpulse=t.body.fractureImpulse,e.body.breakable=!1,setTimeout(()=>{e.body.breakable=!0},2500))}removeDebris(e){this.scene!=="headless"&&(this.scene.remove(e),this.destroy(e))}update(e){this.updatePhysics(e),this.detectCollisions()}updatePhysics(e){const t=e/1e3;this.physicsWorld.stepSimulation(t,this.config.maxSubSteps||4,this.config.fixedTimeStep||1/60);for(let n=0;n<this.rigidBodies.length;n++){const i=this.rigidBodies[n];i.body.impact=[];const o=i.body.ammo.getMotionState();if(o){if(o.getWorldTransform(this.worldTransform),i.body.didUpdate&&(i.body._emitUpdateEvents&&i.body.eventEmitter.emit("update"),i.body.didUpdate=!1),i.body.ammo.isKinematicObject()&&i.body.needUpdate)i.getWorldQuaternion(this.tmpQuaternion),i.getWorldPosition(this.tmpVector3),this.tmpBtVector3.setValue(this.tmpVector3.x,this.tmpVector3.y,this.tmpVector3.z),this.tmpBtQuaternion.setValue(this.tmpQuaternion.x,this.tmpQuaternion.y,this.tmpQuaternion.z,this.tmpQuaternion.w),this.worldTransform.setOrigin(this.tmpBtVector3),this.worldTransform.setRotation(this.tmpBtQuaternion),o.setWorldTransform(this.worldTransform),i.body.needUpdate=!1;else if(!i.body.skipUpdate){if(!i.body.ammo.isStaticObject()){const a=this.worldTransform.getOrigin(),l=this.worldTransform.getRotation(),c=i.body.offset;if(i.body.ignoreScale)this.tmpVector3a.set(i.scale.x,i.scale.y,i.scale.z);else{const h=i.body.ammo.getCollisionShape().getLocalScaling();this.tmpVector3a.set(h.x(),h.y(),h.z())}this.tmpVector3.set(a.x()+c.x,a.y()+c.y,a.z()+c.z),this.tmpQuaternion.set(l.x(),l.y(),l.z(),l.w()),this.tmpMatrix4.compose(this.tmpVector3,this.tmpQuaternion,this.tmpVector3a),i.parent?parseInt(Ps)>=123?this.tmpMatrix4a.copy(i.parent.matrixWorld).invert():this.tmpMatrix4a.getInverse(i.parent.matrixWorld):this.tmpMatrix4a.identity(),this.tmpMatrix4a.multiply(this.tmpMatrix4),this.tmpMatrix4a.decompose(i.position,i.quaternion,i.scale)}}}}}detectCollisions(){var i,s;const e=[];this.impactPoint.set(0,0,0),this.impactNormal.set(0,0,0);const t=this.physicsWorld.getDispatcher(),n=t.getNumManifolds();for(let o=0;o<n;o++){const a=t.getManifoldByIndexInternal(o),l=a.getNumContacts(),c=Ammo.castObject(a.getBody0(),Ammo.btRigidBody),h=Ammo.castObject(a.getBody1(),Ammo.btRigidBody),u=c.threeObject,d=h.threeObject;if(!u||!d||c.name===""&&h.name==="")continue;const f=(i=u.body)==null?void 0:i.checkCollisions,m=(s=d.body)==null?void 0:s.checkCollisions,_=u.body.breakable,g=d.body.breakable,p=u.body.fractureImpulse,S=d.body.fractureImpulse,y=f||m,v=_||g;if(typeof u.fragmentDepth>"u"&&(u.fragmentDepth=0),typeof d.fragmentDepth>"u"&&(d.fragmentDepth=0),!y&&!v)continue;let b=!1,w=0,C="start";for(let M=0;M<l;M++){const E=a.getContactPoint(M);if(E.getDistance()<=0){b=!0;const J=E.getAppliedImpulse(),U=E.get_m_positionWorldOnB(),F=E.get_m_normalWorldOnB();if(f||m){const G=[u.uuid,d.uuid].sort(),V=`${G[0]}__${G[1]}`;if(this.earlierDetectedCollisions.find(N=>N.combinedName===V)&&(C="collision"),!e.find(N=>N.combinedName===V)){e.push({combinedName:V,collision:!0});const N={x:U.x(),y:U.y(),z:U.z()},Q={x:F.x(),y:F.y(),z:F.z()};u.body.impact.push({impulse:J,point:N,normal:Q,name:d.name}),d.body.impact.push({impulse:J,point:N,normal:Q,name:u.name}),this.collisionEvents.emit("collision",{bodies:[u,d],event:C})}}J>=w&&(w=J,(_||g)&&(this.impactPoint.set(U.x(),U.y(),U.z()),this.impactNormal.set(F.x(),F.y(),F.z())));break}}if(!b||!v)continue;const D=2;if(this.emptyV3.set(0,0,0),u.userData.ammoPhysicsData={mass:1,velocity:this.emptyV3,angularVelocity:this.emptyV3,breakable:_,physicsBody:c},d.userData.ammoPhysicsData={mass:1,velocity:this.emptyV3,angularVelocity:this.emptyV3,breakable:g,physicsBody:h},_&&w>p&&u.fragmentDepth<D){const M=this.convexBreaker.subdivideByImpact(u,this.impactPoint,this.impactNormal,1,2),E=M.length;for(let H=0;H<E;H++){const J=c.getLinearVelocity(),U=c.getAngularVelocity(),F=M[H];F.userData.ammoPhysicsData.velocity.set(J.x(),J.y(),J.z()),F.userData.ammoPhysicsData.angularVelocity.set(U.x(),U.y(),U.z()),this.createDebrisFromBreakableObject(F,u)}this.objectsToRemove[this.numObjectsToRemove++]=u}if(g&&w>S&&d.fragmentDepth<D){const M=this.convexBreaker.subdivideByImpact(d,this.impactPoint,this.impactNormal,1,2),E=M.length;for(let H=0;H<E;H++){const J=h.getLinearVelocity(),U=h.getAngularVelocity(),F=M[H];F.userData.ammoPhysicsData.velocity.set(J.x(),J.y(),J.z()),F.userData.ammoPhysicsData.angularVelocity.set(U.x(),U.y(),U.z()),this.createDebrisFromBreakableObject(F,d)}this.objectsToRemove[this.numObjectsToRemove++]=d}}for(let o=0;o<this.numObjectsToRemove;o++)this.removeDebris(this.objectsToRemove[o]);this.numObjectsToRemove=0,this.earlierDetectedCollisions.forEach(o=>{const{combinedName:a}=o;if(!e.find(l=>l.combinedName===a)){const l=a.split("__"),c=this.rigidBodies.find(d=>d.uuid===l[0]),h=this.rigidBodies.find(d=>d.uuid===l[1]),u="end";c&&h&&this.collisionEvents.emit("collision",{bodies:[c,h],event:u})}}),this.earlierDetectedCollisions=[...e]}setGravity(e=0,t=-9.8,n=0){this.tmpBtVector3.setValue(e,t,n),this.physicsWorld.setGravity(this.tmpBtVector3)}get debug(){return this.isHeadless?null:{enable:()=>{this.debugDrawer.enable()},mode:(e=1)=>{this.debugDrawer.setDebugMode(e)},disable:()=>{this.debugDrawer.disable()}}}start(){if(typeof Ammo>"u"){Dn("Are you sure you included ammo.js?");return}typeof Ammo=="function"?Ammo().then(()=>{this.setup()}):this.setup()}get add(){return{collider:(e,t,n)=>this.collisionEvents.addCollider(e,t,n),constraints:this.constraints.addConstraints,existing:(e,t)=>this.addExisting(e,t),plane:(e={},t={})=>this.shapes.addPlane(e,t),sphere:(e={},t={})=>this.shapes.addSphere(e,t),ground:(e={},t={})=>this.shapes.addGround(e,t),box:(e={},t={})=>this.shapes.addBox(e,t),capsule:(e={},t={})=>this.shapes.addCapsule(e,t),cylinder:(e={},t={})=>this.shapes.addCylinder(e,t),cone:(e={},t={})=>this.shapes.addCone(e,t),torus:(e={},t={})=>this.shapes.addTorus(e,t),extrude:(e,t={})=>this.shapes.addExtrude(e,t),raycaster:(e="closest")=>e==="closest"?new Ih(this):new Dh(this)}}prepareThreeObjectForCollisionShape(e,t={}){var l,c;const{autoCenter:n=!1}=t,i={width:1,height:1,depth:1,radius:1,radiusTop:1,radiusBottom:1,tube:.4,tubularSegments:6};let s="unknown";const o=((l=e.geometry)==null?void 0:l.type)||"unknown";/box/i.test(o)?s="box":/cone/i.test(o)?s="cone":/cylinder/i.test(o)?s="cylinder":/extrude/i.test(o)?s="extrude":/plane/i.test(o)?s="plane":/sphere/i.test(o)?s="sphere":/torus/i.test(o)&&(s="torus");let a={...i,...(c=e==null?void 0:e.geometry)==null?void 0:c.parameters};if(t.shape?(a={...i,...t},s=t.shape):e.shape&&(s=e.shape),Object.keys(a).forEach(h=>{typeof a[h]>"u"&&i[h]&&(a[h]=i[h])}),n){if(e.isMesh&&e.geometry)e.geometry.center();else if(e.isGroup){const h=new rn,u=new A;h.setFromObject(e).getCenter(u),e.traverse(d=>{d.isMesh&&d.geometry.translate(-u.x,-u.y,-u.z)})}}return s==="cylinder"&&(a.radius=t.radius||a.radiusTop),s==="extrude"&&(s="hacd"),(s==="mesh"||s==="convex")&&(s="convexMesh"),s==="concave"&&(s="concaveMesh"),s==="unknown"&&(Dn(`Shape for ${e==null?void 0:e.name} not recognized! Will fallback to box.`),s="box"),{shape:s,params:a,object:e}}createCollisionShape(e,t,n){const i=n!=null&&n.quaternion?n==null?void 0:n.quaternion:new It(0,0,0,1),{axis:s="y"}=t,o=new Ammo.btVector3,a=n==null?void 0:n.geometry;n&&(a!=null&&a.isGeometry)&&(n.geometry=new mt().fromGeometry(a));const l=m=>{const _=new Oe().elements,g=[],p=[],S=[];return xy(m,{},(y,v,b)=>{g.push(y),p.push(v),S.push(b)}),{vertices:g,matrices:p,indexes:S,matrixWorld:_}};let c={};this.complexShapes.indexOf(e)!==-1&&(c=l(n));let h;switch(e){case"box":o.setValue(t.width/2,t.height/2,t.depth/2),h=new Ammo.btBoxShape(o);break;case"sphere":h=new Ammo.btSphereShape(t.radius);break;case"cylinder":switch(s){case"y":o.setValue(t.radius,t.height/2,t.radius),h=new Ammo.btCylinderShape(o);break;case"x":o.setValue(t.height/2,t.radius,t.radius),h=new Ammo.btCylinderShapeX(o);break;case"z":o.setValue(t.radius,t.radius,t.height/2),h=new Ammo.btCylinderShapeZ(o);break}break;case"cone":switch(s){case"y":h=new Ammo.btConeShape(t.radius,t.height);break;case"x":h=new Ammo.btConeShapeX(t.radius,t.height);break;case"z":h=new Ammo.btConeShapeZ(t.radius,t.height);break}break;case"capsule":switch(s){case"y":h=new Ammo.btCapsuleShape(t.radius,t.height);break;case"x":h=new Ammo.btCapsuleShapeX(t.radius,t.height);break;case"z":h=new Ammo.btCapsuleShapeZ(t.radius,t.height);break}break;case"torus":h=vy(t,i);break;case"plane":h=Do(c.vertices,c.matrices,c.indexes,c.matrixWorld,{...t,concave:!1});break;case"hull":h=gy(c.vertices,c.matrices,c.matrixWorld,t);break;case"hacd":h=_y(c.vertices,c.matrices,c.indexes,c.matrixWorld,t);break;case"vhacd":h=yy(c.vertices,c.matrices,c.indexes,c.matrixWorld,t);break;case"convexMesh":h=Do(c.vertices,c.matrices,c.indexes,c.matrixWorld,{...t,concave:!1});break;case"concaveMesh":h=Do(c.vertices,c.matrices,c.indexes,c.matrixWorld,{...t,concave:!0});break}Ammo.destroy(o);const{x:u,y:d,z:f}=t;return(u||d||f)&&(h._compoundOffset={x:u||0,y:d||0,z:f||0}),Array.isArray(h)&&(h=this.mergeCollisionShapesToCompoundShape(h)),h}mergeCollisionShapesToCompoundShape(e){const t=new Ammo.btCompoundShape;return e.forEach(n=>{const{_childOffset:i,_compoundOffset:s}=n;if(i){const{pos:o,quat:a,scale:l,margin:c}=i,h=this.applyPosQuatScaleMargin(n,o,a,l,c);t.addChildShape(h,n)}else if(s){const o=new Ammo.btTransform;o.setIdentity(),o.setOrigin(new Ammo.btVector3(s.x,s.y,s.z)),t.addChildShape(o,n)}else{const o=new Ammo.btTransform;o.setIdentity(),t.addChildShape(o,n)}}),t}addExisting(e,t={}){const{hasBody:n}=e;if(n){Dn(`Object "${e.name}" already has a physical body!`);return}const i=new A,s=new It,o=new A;e.getWorldPosition(i),e.getWorldQuaternion(s),e.getWorldScale(o);const a=(t.collisionFlags||0).toString(2).slice(-1)==="1",l=(t.collisionFlags||0).toString(2).slice(-2,-1)==="1",{shape:c="unknown",compound:h=[],mass:u=a||l?0:1,collisionFlags:d=0,collisionGroup:f=1,collisionMask:m=-1,offset:_=void 0,breakable:g=!1,addChildren:p=!0,margin:S=.01,ignoreScale:y=!1,fractureImpulse:v=1}=t;if(y&&o.set(1,1,1),h.length>=1){const M=h.map(U=>this.createCollisionShape(U.shape,U)),E=this.mergeCollisionShapesToCompoundShape(M),H=this.applyPosQuatScaleMargin(E,i,s,o,S),J=this.collisionShapeToRigidBody(E,H,u,l);this.addRigidBodyToWorld(e,J,d,f,m,_),e.body.breakable=g,e.body.fractureImpulse=v,e.body.ignoreScale=y;return}const b=[];if(c!=="unknown"||e.isMesh){const M=this.prepareThreeObjectForCollisionShape(e,t),E=this.createCollisionShape(M.shape,M.params,M.object);b.push(E)}if(c==="unknown"&&p&&e.children.length>=1&&e.children.forEach(M=>{if(M.isMesh){const E=this.prepareThreeObjectForCollisionShape(M),H=this.createCollisionShape(E.shape,E.params,E.object);H._childOffset={pos:M.position.clone(),quat:M.quaternion.clone(),scale:M.scale.clone(),margin:S},b.push(H)}}),b.length===0){const M=this.prepareThreeObjectForCollisionShape(e,t),E=this.createCollisionShape(M.shape,M.params,M.object);b.push(E)}const w=b.length===1?b[0]:this.mergeCollisionShapesToCompoundShape(b),C=this.applyPosQuatScaleMargin(w,i,s,o,S),D=this.collisionShapeToRigidBody(w,C,u,l);this.addRigidBodyToWorld(e,D,d,f,m,_),e.body.breakable=g,e.body.fractureImpulse=v,e.body.ignoreScale=y}addRigidBodyToWorld(e,t,n,i,s,o){this.rigidBodies.push(e),this.physicsWorld.addRigidBody(t,i,s);const a=Object.values(t)[0];e.name||(e.name=`object-${e.id}`),t.name=e.name,e.body=new dy(this,t),e.hasBody=!0,e.ptr=a,t.threeObject=e,o&&(e.body.offset={x:0,y:0,z:0,...o}),e.body.setCollisionFlags(n)}applyPosQuatScaleMargin(e,t=new A,n=new It,i=new A,s=.01){e.setMargin(s);const o=new Ammo.btQuaternion(0,0,0,1);o.setValue(n.x,n.y,n.z,n.w);const a=new Ammo.btTransform;a.setIdentity(),a.getOrigin().setValue(t.x,t.y,t.z),a.setRotation(o),Ammo.destroy(o);const l=new Ammo.btVector3(i.x,i.y,i.z);return e.setLocalScaling(l),Ammo.destroy(l),a}collisionShapeToRigidBody(e,t,n,i){const s=new Ammo.btDefaultMotionState(t),o=new Ammo.btVector3(0,0,0);n>0&&e.calculateLocalInertia(n,o);const a=new Ammo.btRigidBodyConstructionInfo(n,s,e,o),l=new Ammo.btRigidBody(a);return(n>0||i)&&l.setActivationState(4),l}}const tt=Nh(),Pt=document.getElementById("titleScreen");Pt.style.background="linear-gradient(to bottom, green, black)";const Kt=document.querySelector("#lobbyScreen");Kt.style.background="linear-gradient(to bottom, green, black)";const Fo=document.getElementById("playerNameInput"),Ny=document.getElementById("createLobbyButton"),Fy=document.getElementById("joinLobbyButton"),Oy=document.getElementById("lobbyCodeInput"),By=document.getElementById("lobbyCodeDisplay"),Rc=document.getElementById("playerList"),Oo=document.getElementById("startGameButton"),ri=document.getElementById("mapSelectionScreen");ri.style.background="linear-gradient(to bottom, green, black)";const zy=document.getElementById("backToLobbyButton"),Cc=document.getElementById("confirmMapButton"),Vy=document.getElementById("leaveLobbyButton"),ky=document.getElementById("gameEndScreen");ky.style.background="linear-gradient(to bottom, green, black)";let Bo="",Rn="",vr="",Lc="";const Ye=new s_;Ye.background=new Ne(140,255,115);const wt=new Vt(75,window.innerWidth/window.innerHeight,.1,1e3),dn=new lh({antialias:!0});dn.setPixelRatio(window.devicePixelRatio);dn.setSize(window.innerWidth,window.innerHeight);dn.shadowMap.enabled=!0;dn.shadowMap.type=na;dn.toneMapping=Uc;dn.setSize(window.innerWidth,window.innerHeight);document.body.appendChild(dn.domElement);document.body.style.overflow="hidden";Py("/ammo",()=>{const r=new Uy(Ye);r.debug.enable();const e={};let t=!1,n=10,i=!1,s=!1,o=!1,a=!1,l=0,c=0,h=!1,u=!1,d=!1,f=[],m=!1;const _=document.getElementById("loginButton"),g=document.getElementById("signInScreen");g.style.background="linear-gradient(to bottom, green, black)",_.addEventListener("click",()=>{Pt.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{Pt.classList.add("hidden"),g.classList.remove("hidden","opacity-0"),g.classList.add("flex","opacity-100","transition-opacity","duration-500")},500)});const p=document.getElementById("signUpEmail"),S=document.getElementById("signUpPassword");document.getElementById("signUpButton").addEventListener("click",async()=>{if(!p||!S){alert("Sign-up elements not found.");return}const P=p.value.trim(),X=S.value.trim();if(!P||!X){alert("Please fill in all fields.");return}try{const ee=await fetch("/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:P,password:X})}),ae=await ee.json();ee.ok?(alert("Sign-up successful! Please log in."),b.classList.add("hidden"),g.classList.remove("hidden")):alert(ae.message||"Sign-up failed.")}catch(ee){console.error("Error during sign-up:",ee),alert("An error occurred. Please try again.")}});const v=document.getElementById("goToSignUp"),b=document.getElementById("signUpScreen");b.style.background="linear-gradient(to bottom, green, black)",v.addEventListener("click",()=>{g.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{g.classList.add("hidden"),b.classList.remove("hidden","opacity-0"),b.classList.add("flex","opacity-100","transition-opacity","duration-500")},500)}),document.getElementById("goToSignIn").addEventListener("click",()=>{b.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{b.classList.add("hidden"),g.classList.remove("hidden","opacity-0"),g.classList.add("flex","opacity-100","transition-opacity","duration-500")},500)});const C=document.getElementById("signInEmail"),D=document.getElementById("signInPassword");document.getElementById("signInButton").addEventListener("click",async()=>{if(!C||!D){alert("Sign-in elements not found.");return}const P=C.value.trim(),X=D.value.trim();if(!P||!X){alert("Please fill in all fields.");return}try{const ee=await fetch("/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:P,password:X})}),ae=await ee.json();ee.ok?(alert("Login successful!"),Lc=P,g.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{g.classList.add("hidden"),Pt.classList.remove("hidden","opacity-0"),Pt.classList.add("flex","opacity-100","transition-opacity","duration-500"),Fo.value=`Hello, ${Lc}`},500)):alert(ae.message||"Login failed.")}catch(ee){console.error("Error during login:",ee),alert("An error occurred. Please try again.")}});const E=document.getElementById("returnToTitleFromSignIn"),H=document.getElementById("returnToTitleFromSignUp");E.addEventListener("click",()=>{g.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{g.classList.add("hidden"),Pt.classList.remove("hidden","opacity-0"),Pt.classList.add("flex","opacity-100","transition-opacity","duration-500")},500)}),H.addEventListener("click",()=>{b.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{b.classList.add("hidden"),Pt.classList.remove("hidden","opacity-0"),Pt.classList.add("flex","opacity-100","transition-opacity","duration-500")},500)}),Ny.addEventListener("click",()=>{const P=Fo.value.trim();if(!P){alert("Please enter your name.");return}Rn=ay(6).toUpperCase(),tt.emit("createLobby",{playerName:P,lobbyCode:Rn}),Pt.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{Pt.classList.add("hidden"),ri.classList.remove("hidden","opacity-0"),ri.classList.add("flex","opacity-100","transition-opacity","duration-500")},500)}),zy.addEventListener("click",()=>{ri.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{ri.classList.add("hidden"),Kt.classList.remove("hidden","opacity-0"),Kt.classList.add("flex","opacity-100","transition-opacity","duration-500")},500),tt.emit("backToLobby",Rn)}),Vy.addEventListener("click",()=>{Kt.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{Kt.classList.add("hidden"),Pt.classList.remove("hidden","opacity-0"),Pt.classList.add("flex","opacity-100","transition-opacity","duration-500")},500),tt.emit("leaveLobby",Rn)}),document.querySelectorAll(".map-option").forEach(P=>{P.addEventListener("click",()=>{document.querySelectorAll(".map-option").forEach(X=>{X.classList.remove("border-4","border-green-500")}),P.classList.add("border-4","border-green-500"),Bo=P.dataset.map,Cc.disabled=!1,console.log(`Selected map: ${Bo}`)})}),Fy.addEventListener("click",()=>{const P=Fo.value.trim(),X=Oy.value.trim().toUpperCase();if(!P||!X){alert("Please enter your name and a lobby code.");return}tt.emit("joinLobby",{playerName:P,lobbyCode:X}),Pt.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{Pt.classList.add("hidden"),Kt.classList.remove("hidden","opacity-0"),Kt.classList.add("flex","opacity-100","transition-opacity","duration-500")},500)}),Cc.addEventListener("click",()=>{tt.emit("mapSelected",{lobbyCode:Rn,map:Bo}),ri.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{ri.classList.add("hidden"),Kt.classList.remove("hidden","opacity-0"),Kt.classList.add("flex","opacity-100","transition-opacity","duration-500"),By.textContent=Rn},500)}),tt.on("mapSelected",({map:P})=>{console.log("Map selection complete"),console.log(P)});async function J(P){return new Promise((X,ee)=>{const ae=P==="Map1"?"assets/lowPolyKitchenWhole.glb":P==="Map2"?"assets/Apartment 2.glb":null;if(!ae){ee(`Invalid map selected: ${P}`);return}console.log(`Loading map: ${P} from path: ${ae}`);const Re=P==="Map1"?1:500,$e=P==="Map1"?0:50;new gr().load(ae,We=>{const Xt=We.scene;Xt.scale.set(Re,Re,Re),Xt.position.y=$e;const T=new rn().setFromObject(Xt);console.log("Bounding Box:",T.min,T.max);const B=new w0(T,16711680);Ye.add(B),Xt.traverse(q=>{var z;if(q.isMesh){q.castShadow=!0,q.receiveShadow=!0;const j=q.geometry;if((z=j==null?void 0:j.attributes)!=null&&z.position){const ve=Array.from(j.attributes.position.array||[]),Ue=j.index?Array.from(j.index.array||[]):void 0,Ve=ve.map((pt,Ht)=>(Ht%3===1,pt*Re)),Fe=new A,He=new It,ze=new A;q.updateMatrixWorld(),q.matrixWorld.decompose(Fe,He,ze);const ke=new mt;ke.setAttribute("position",new it(Ve,3)),Ue&&ke.setIndex(Ue);const ut=r.add.existing(q,{shape:"concave"});ut.position.set(Fe.x,Fe.y,Fe.z),ut.quaternion.set(He.x,He.y,He.z,He.w),O(ke,Ye)}}}),Ye.add(Xt),console.log(`Map "${P}" loaded successfully.`),X()},void 0,We=>{ee(We)})})}Oo.addEventListener("click",()=>{console.log("hit"),tt.emit("startGame",{lobbyCode:Rn})}),tt.on("lobbyUpdate",({players:P,host:X})=>{Rc.innerHTML="",P.forEach(ee=>{const ae=document.createElement("li");ae.className="flex items-center justify-between bg-gray-700 p-3 rounded-md",ae.innerHTML=`
    ...
    `,side:kt,blending:zo,transparent:!0}),ae=new dt(X,ee);return ae.position.copy(P),ae.scale.set(1.2,1.2,1.2),ae}const ye={xMin:-150,xMax:175.9,yMin:1,yMax:10,zMin:-178.8,zMax:179},Se=[];function Te(P){for(let X=0;X<P;X++){const ee=new A(Hn.randFloat(ye.xMin,ye.xMax),Hn.randFloat(ye.yMin,ye.yMax),Hn.randFloat(ye.zMin,ye.zMax));de.load("assets/Pickup Thunder.glb",ae=>{const Re=ae.scene;Re.scale.set(5,5,5),Re.position.copy(ee),Ye.add(Re);const $e=r.add.existing(Re,{shape:"sphere",radius:10});$e.position.set(ee.x,ee.y,ee.z);const Qe=_e(pe);Ye.add(Qe),Se.push({mesh:Re,body:$e})},void 0,ae=>{console.error("Error loading power-up model:",ae)})}}(()=>{const P=new Ln(10,16,16),X=new Ft({color:16711680,wireframe:!0}),ee=new dt(P,X);ee.position.copy(pe),Ye.add(ee)})();function et(){Se.forEach((P,X)=>{if(!P||!P.mesh||!P.body)return;K.position.distanceTo(P.mesh.position)<5&&Pe(X)})}function Pe(P){const X=Se[P];if(!X)return;const ee=new Ln(5,32,32),ae=new Ft({color:16763904,transparent:!0,opacity:.7}),Re=new dt(ee,ae);Re.position.copy(X.mesh.position),Ye.add(Re),setTimeout(()=>{Ye.remove(Re)},500),Ye.remove(X.mesh),world.removeBody(X.body),Se.splice(P,1),L(),console.log(`Power-up collected: index ${P}`)}function L(){const P=n;n=20,setTimeout(()=>{n=P},7e3),console.log("Speed boost activated!")}function ce(P){const X=1+.1*Math.sin(Date.now()*.005);P.scale.set(X,X,X)}dn.shadowMap.enabled=!0,dn.shadowMap.type=na;const Z=new Eh(16777215,1);Z.color.setHSL(.1,1,.95),Z.position.set(-1,1.75,1).multiplyScalar(30),Z.castShadow=!0,Z.shadow.mapSize.width=2048,Z.shadow.mapSize.height=2048;const se=1e4;Z.shadow.camera.left=-se,Z.shadow.camera.right=se,Z.shadow.camera.top=se,Z.shadow.camera.bottom=-se,Z.shadow.camera.near=1,Z.shadow.camera.far=1e3,Z.shadow.bias=-1e-4,Ye.add(Z);const ne=new A0(Z,10);Ye.add(ne);const Ae=new a0(8900331,16777215,.5);Ae.color.setHSL(.6,1,.6),Ae.groundColor.setHSL(1e-4,1,.75),Ae.position.set(0,50,0),Ye.add(Ae),K.castShadow=!0,K.receiveShadow=!0;const xe=new $i(2e3,2e3),be=new Is({color:8421504}),Be=new dt(xe,be);Be.rotation.x=-Math.PI/2,Be.position.y=-23,Be.receiveShadow=!0,Ye.add(Be);let De={};const ct=0;wt.position.set(0,ct+2,0),K.position.set(0,ct,0),K.castShadow=!0,K.receiveShadow=!0,K.add(wt);const R=1;let x=r.add.sphere({radius:R,mass:5,collisionFlags:0,position:{x:0,y:ct+1,z:0},collisionGroup:1,collisionMask:2});const W={x:124,y:128.5,z:138.6};function re(){const P=K.position,X=-150,ee=175.9,ae=-178.8,Re=179;P.x=Hn.clamp(P.x,X,ee),P.y=Hn.clamp(P.y,0,W.y),P.z=Hn.clamp(P.z,ae,Re)}document.addEventListener("mousemove",P=>{m&&(l-=P.movementX*.002,c-=P.movementY*.002,c=Math.max(-Math.PI/2,Math.min(Math.PI/2,c)),x.body.setRotationFromAxisAngle(new A(0,1,0),l),wt.rotation.x=c)}),document.addEventListener("click",()=>{t&&!m&&(document.body.requestPointerLock(),m=!0)}),window.addEventListener("keydown",P=>{switch(P.code){case"KeyW":i=!0;break;case"KeyS":s=!0;break;case"KeyA":o=!0;break;case"KeyD":a=!0;break;case"Space":break;case"ShiftLeft":u=!0;break;case"ControlLeft":d=!1;break;case"Escape":m&&(document.exitPointerLock(),m=!1,console.log("Game paused"));break}}),window.addEventListener("keyup",P=>{switch(P.code){case"KeyW":i=!1;break;case"KeyS":s=!1;break;case"KeyA":o=!1;break;case"KeyD":a=!1;break;case"ShiftLeft":u=!1;break;case"ControlLeft":d=!1;break}}),window.addEventListener("mousedown",P=>{P.button===0&&ie()});function ie(){try{const ee=new Ln(1.1,16,16),ae=new Ft({color:16711680}),Re=new dt(ee,ae),$e=new A;wt.getWorldPosition($e);const Qe=new A;wt.getWorldDirection(Qe),Re.position.copy($e.add(Qe.multiplyScalar(3))),Ye.add(Re);const We=r.add.existing(Re,{shape:"sphere",radius:1.1,mass:.1}),Xt=Qe.multiplyScalar(150);We.body.setVelocity(Xt.x,Xt.y,Xt.z),f.push({mesh:Re,body:We.body}),We.body.on.collision(T=>{const B=T.body;Object.values(De).forEach(q=>{if(q.body===B){const z=Object.keys(De).find(j=>De[j].body===B);q.health-=20,we(z),console.log(`Player ${z} hit! Health: ${q.health}`),le(q.mesh.position),q.health<=0&&Ze(z)}}),oe(Re,We.body)}),tt.emit("updateStats",{username:"PlayerName",shotsFired:1}),setTimeout(()=>{oe(Re,We.body)},1e4)}catch(P){console.error("Error in shootSphere function:",P)}}function oe(P,X,ee){Ye.children.includes(P)&&(Ye.remove(P),P.geometry&&P.geometry.dispose(),P.material&&P.material.dispose()),Ye.children.includes(ee)&&(Ye.remove(ee),ee.geometry&&ee.geometry.dispose(),ee.material&&ee.material.dispose()),world.bodies.includes(X)&&world.removeBody(X),f=f.filter(ae=>ae.body!==X)}function we(P){const X=De[P];if(!X)return;const ee=Math.max(0,X.health/100),ae=Ce[P];ae&&(ae.scale.set(ee,1,1),ae.material.color.setHex(ee>.5?65280:ee>.25?16776960:16711680),ee<=0&&Ze(P))}function le(P){const ee=new Xn;for(let Re=0;Re<30;Re++){const $e=new Ln(.05,4,4),Qe=new Ft({color:9109504}),We=new dt($e,Qe);We.position.copy(P),We.velocity=new A((Math.random()-.5)*4,(Math.random()-.25)*2,(Math.random()-.5)*4),ee.add(We)}Ye.add(ee),setTimeout(()=>{Ye.remove(ee)},500);const ae=()=>{ee.children.forEach(Re=>{Re.position.add(Re.velocity),Re.material.opacity-=.03}),ee.children.some(Re=>Re.material.opacity>0)?requestAnimationFrame(ae):Ye.remove(ee)};ae()}const Y={},Ce={};function Le(P,X=100){const ee=new $i(1.5,.2),ae=new Ft({color:65280}),Re=new dt(ee,ae);Re.position.set(0,1.5,0),P.add(Re),Y[P.id]=X,Ce[P.id]=Re}function Ie(){for(let P=f.length-1;P>=0;P--){const X=f[P];if(!X||!X.mesh||!X.body){f.splice(P,1);continue}X.mesh.position.copy(X.body.position),X.mesh.quaternion.copy(X.body.quaternion),X.mesh.position.length()>1e3&&(Ye.remove(X.mesh),world.removeBody(X.body),f.splice(P,1))}}x.collisionResponse=!0,x.allowSleep=!1,x.collisionFilterGroup=1,x.collisionFilterMask=2,x.linearDamping=.1,x.ccdMotionThreshold=1,x.ccdSweptSphereRadius=R,x.angularDamping=.9,x.fixedRotation=!0;function Ee(){if(!x||!x.body){console.warn("playerBody or playerBody.body is not properly initialized:",x);return}const P=5;x.body.setVelocity(0,0,0);const X=new A;wt.getWorldDirection(X);const ee=new A;ee.crossVectors(wt.up,X).normalize();const ae=new A;i&&ae.add(X),s&&ae.add(X.clone().negate()),o&&ae.add(ee.clone().negate()),a&&ae.add(ee),ae.length()>0&&(ae.normalize(),ae.multiplyScalar(n)),vr==="Insect"&&(u&&(ae.y+=P),d&&(ae.y-=P)),new A().copy(x.position).add(ae),x.body.setVelocity(ae.x,ae.y,ae.z),vr!=="Insect"&&x.body.setVelocityY(0),x.body.setAngularVelocity(0,0,0)}let Me=!0;window.addEventListener("blur",()=>{Me=!1}),window.addEventListener("focus",()=>{Me=!0});function Ge(){if(t&&(requestAnimationFrame(Ge),!!Me))try{const P=.016666666666666666;r.update(P),Object.values(De).forEach(X=>{X.updateHitbox&&X.updateHitbox(),X.mixer&&X.mixer.update(P)}),$(),Ee(),re(),Ie(),Se.length>0&&et(),Se.forEach(X=>{X.glowMesh&&ce(X.glowMesh)}),tt.emit("move",{position:K.position,isFlying:h}),dn.render(Ye,wt)}catch(P){console.error("Error in animation loop:",P)}}tt.on("shoot",P=>{const ae=new Ln(1.1,8,8),Re=new Ft({color:16711680}),$e=new dt(ae,Re);$e.position.copy(P.position);const Qe=r.add.existing($e,{shape:"sphere",radius:1.1,mass:.1});Qe.body.setVelocity(P.velocity.x,Math.max(P.velocity.y,0),P.velocity.z),Ye.add($e),f.push({mesh:$e,body:Qe.body}),console.log(`Player ${P.id} shot from position:`,P.position,"with velocity:",P.velocity)});function st(P){console.log("Game over!"),t=!1,U.pause(),U.currentTime=0;const X=vr==="Human"?P:!P;tt.emit("endGame",{isWinner:X}),P&&tt.emit("updateStats",{username:"PlayerName",wins:1}),I(X)}tt.on("endGame",({isWinner:P})=>{console.log(`Game ended. You ${P?"won!":"lost!"}`),t=!1,I(P)});function I(P){const X=document.getElementById("gameEndScreen"),ee=document.getElementById("gameResultTitle"),ae=document.getElementById("gameResultMessage");P?(ee.textContent="🏆 Congratulations!",ae.textContent="You Won!",confetti({particleCount:100,spread:100,origin:{y:.6}})):(ee.textContent="💔 Game Over",ae.textContent="You Lost!"),X.classList.remove("hidden","opacity-0"),X.classList.add("flex","opacity-100","transition-opacity","duration-500"),document.getElementById("returnToTitleButton").addEventListener("click",()=>{X.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{X.classList.add("hidden"),Pt.classList.remove("hidden","opacity-0"),Pt.classList.add("flex","opacity-100","transition-opacity","duration-500"),me()},500)}),document.getElementById("playAgainButton").addEventListener("click",()=>{X.classList.add("opacity-0","transition-opacity","duration-500"),setTimeout(()=>{X.classList.add("hidden"),Kt.classList.remove("hidden","opacity-0"),Kt.classList.add("flex","opacity-100","transition-opacity","duration-500"),me(),tt.emit("playAgain",{lobbyCode:Rn})},500)})}tt.on("endGame",({isWinner:P})=>{console.log(`Game ended. You ${P?"won!":"lost!"}`),t=!1,I(P)});function me(){De={},vr="",Rn="",f.forEach(({mesh:P,body:X})=>{Ye.children.includes(P)&&Ye.remove(P),world.bodies.includes(X)&&world.removeBody(X)}),f=[],V.innerHTML=""}tt.on("newPlayer",P=>{ge(P.id,{role:P.role}),console.log(P)}),tt.on("currentPlayers",P=>{Object.keys(P).forEach(X=>{X!==tt.id&&ge(X,{role:P[X].role})})}),tt.on("playerMoved",P=>{const{id:X,position:ee}=P;X!==tt.id&&De[X]&&(console.log(ee),De[X].body.position.set(ee.x,ee.y,ee.z),De[X].mesh.position.set(ee.x,ee.y,ee.z),console.log(`Player ${X} moved to position:`,ee))}),tt.on("lobbyFull",()=>{console.log("Lobby is full! Starting the game..."),loadingMessage.innerText="Game starting...",setTimeout(()=>{loadingMessage.style.display="none",Ge()},1e3)});const k=document.createElement("div");k.style.position="fixed",k.style.top="20px",k.style.left="50%",k.style.transform="translateX(-50%)",k.style.padding="10px 20px",k.style.backgroundColor="rgba(0, 0, 0, 0.7)",k.style.color="#fff",k.style.fontSize="24px",k.style.borderRadius="8px",k.style.zIndex="1000",k.style.display="none",document.body.appendChild(k);function ue(P){k.textContent=`You are a ${P}`,k.style.display="block",setTimeout(()=>{k.style.display="none"},5e3)}tt.on("assignRole",async P=>{h=P==="Insect";const X=new gr;ue(P);try{if(P==="Insect"){const ee=await X.loadAsync("assets/CharacterFly.glb"),ae=ee.scene;ae.scale.set(1,1,1),x&&x.position&&ae.position.set(x.position.x,x.position.y,x.position.z),ae.rotation.y=Math.PI,ae.traverse(Qe=>{Qe.isMesh&&(Qe.castShadow=!0,Qe.receiveShadow=!0)}),K.parent&&Ye.remove(K),K=ae,Ye.add(K);const Re=new Ammo.btBoxShape(new Ammo.btVector3(.5,.2,.5));x=r.add.existing(K,{shape:"box",width:.5,height:.2,depth:.5,mass:5}),K.add(wt),wt.position.set(0,2,0),wt.rotation.set(0,Math.PI/1,0),wt.rotation.order="YXZ",ee.animations&&ee.animations.length>0&&new Co(ae).clipAction(ee.animations[0]).play()}else if(P==="Human"){const ee=await X.loadAsync("assets/CharacterHuman.glb"),ae=ee.scene;ae.scale.set(1,1,1),x&&x.position&&ae.position.set(x.position.x,x.position.y,x.position.z),ae.rotation.set(0,0,0),ae.traverse(Qe=>{Qe.isMesh&&(Qe.castShadow=!0,Qe.receiveShadow=!0)}),K.parent&&Ye.remove(K),K=ae,Ye.add(K);const Re=new Ammo.btBoxShape(new Ammo.btVector3(.5,1,.5));x=r.add.existing(K,{shape:"box",width:.5,height:1,depth:.5,mass:5}),K.add(wt),wt.position.set(0,75,8),wt.rotation.set(0,Math.PI/1,0),ee.animations&&ee.animations.length>0&&new Co(ae).clipAction(ee.animations[0]).play()}}catch(ee){console.error("Error loading model:",ee)}console.log(`Player assigned role: ${P}`)});async function ge(P,X){console.log(X,"Adding new player...");const ee=new gr,ae=X==="Insect"?"assets/CharacterFly.glb":"assets/CharacterHuman.glb";try{const Re=await ee.loadAsync(ae),$e=Re.scene;$e.scale.set(X==="Insect"?2:1,X==="Insect"?2:1,X==="Insect"?2:1),$e.position.set(0,0,0),Ye.add($e);const Qe=r.add.existing($e,{shape:"sphere",radius:5,mass:5});Qe.position.set(0,1,0);let We=null;Re.animations&&Re.animations.length>0&&(We=new Co($e),We.clipAction(Re.animations[1]).play()),De[P]={mesh:$e,body:Qe.body,health:100,role:X,mixer:We},Le($e);const Xt=()=>{Qe.position&&Qe.quaternion&&($e.position.copy(Qe.position),$e.quaternion.copy(Qe.quaternion)),We&&We.update(1/60)};De[P].updateHitbox=Xt,console.log(`Added player ${P} as ${X}`)}catch(Re){console.error(`Error loading model for player ${P}:`,Re)}}function Ze(P){const X=De[P];X&&(Ye.remove(X.mesh),delete De[P],delete Y[P],delete Ce[P],console.log(`Player ${P} removed from game.`)),ht()}function ht(){let P=0,X=!1;Object.values(De).forEach(ee=>{ee.role==="Insect"&&ee.health>0?P++:ee.role==="Human"&&ee.health>0&&(X=!0)}),X?P===0&&st(!0):st(!1)}N&&V&&N.addEventListener("focus",()=>{V.style.opacity="1",V.style.transform="scale(1)",N.style.opacity="1",N.style.transform="scale(1)"}),N.addEventListener("blur",()=>{N.value.trim()===""&&(V.style.opacity="0.3",V.style.transform="scale(0.95)",N.style.opacity="0.3",N.style.transform="scale(0.95)")}),document.addEventListener("keydown",P=>{P.key==="Enter"&&document.activeElement!==N&&N.focus()}),N.addEventListener("keydown",P=>{if(P.key==="Enter"&&N.value.trim()!==""){const X=N.value;tt.emit("chatMessage",{id:tt.id,message:X}),gt("Me",X),N.value="",N.blur()}});function gt(P,X){const ee=document.createElement("div");ee.textContent=`${P}: ${X}`,V.appendChild(ee),V.scrollTop=V.scrollHeight}tt.on("chatMessage",P=>{gt(`Player ${P.id}`,P.message)}),window.addEventListener("resize",fn);function fn(){wt.aspect=window.innerWidth/window.innerHeight,wt.updateProjectionMatrix(),dn.setSize(window.innerWidth,window.innerHeight)}function at(){const P=document.createElement("canvas");P.id="backgroundCanvas",P.style.position="absolute",P.style.top="0",P.style.left="0",P.style.width="100%",P.style.height="100%",P.style.zIndex="-1",document.body.appendChild(P);const X=P.getContext("2d"),ee=[],ae=100;for(let We=0;We<ae;We++)ee.push({x:Math.random()*P.width,y:Math.random()*P.height,radius:Math.random()*3+1,dx:Math.random()*2-1,dy:Math.random()*2-1});function Re(){X.clearRect(0,0,P.width,P.height),ee.forEach(We=>{X.beginPath(),X.arc(We.x,We.y,We.radius,0,Math.PI*2),X.fillStyle="rgba(255, 255, 255, 0.8)",X.fill(),X.closePath()})}function $e(){ee.forEach(We=>{We.x+=We.dx,We.y+=We.dy,(We.x<0||We.x>P.width)&&(We.dx*=-1),(We.y<0||We.y>P.height)&&(We.dy*=-1)})}function Qe(){Re(),$e(),requestAnimationFrame(Qe)}Qe()}at();const Jt=new Audio("assets/click.mp3"),Lt=new Audio("assets/click.mp3");function Fs(P){P.addEventListener("click",()=>{Jt.play()}),P.addEventListener("mouseover",()=>{Lt.play()})}document.querySelectorAll("button").forEach(Fs)});
